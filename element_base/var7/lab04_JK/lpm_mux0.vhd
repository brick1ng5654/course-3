...
ENTITY lpm_mux0 IS
	...
	(
		...
		data10x		: IN STD_LOGIC_VECTOR (2 DOWNTO 0);
		data11x		: IN STD_LOGIC_VECTOR (2 DOWNTO 0);
		data12x		: IN STD_LOGIC_VECTOR (2 DOWNTO 0);
		data13x		: IN STD_LOGIC_VECTOR (2 DOWNTO 0);
		data14x		: IN STD_LOGIC_VECTOR (2 DOWNTO 0);
		data15x		: IN STD_LOGIC_VECTOR (2 DOWNTO 0);
		...
		data8x		: IN STD_LOGIC_VECTOR (2 DOWNTO 0);
		data9x		: IN STD_LOGIC_VECTOR (2 DOWNTO 0);
...
--	type STD_LOGIC_2D is array (NATURAL RANGE <>, NATURAL RANGE <>) of STD_LOGIC;
	...
	SIGNAL sub_wire2	: STD_LOGIC_2D (15 DOWNTO 0, 2 DOWNTO 0);
	...
	SIGNAL sub_wire11	: STD_LOGIC_VECTOR (2 DOWNTO 0);
	SIGNAL sub_wire12	: STD_LOGIC_VECTOR (2 DOWNTO 0);
	SIGNAL sub_wire13	: STD_LOGIC_VECTOR (2 DOWNTO 0);
	SIGNAL sub_wire14	: STD_LOGIC_VECTOR (2 DOWNTO 0);
	SIGNAL sub_wire15	: STD_LOGIC_VECTOR (2 DOWNTO 0);
	SIGNAL sub_wire16	: STD_LOGIC_VECTOR (2 DOWNTO 0);
	SIGNAL sub_wire17	: STD_LOGIC_VECTOR (2 DOWNTO 0);

BEGIN
	sub_wire17    <= data0x(2 DOWNTO 0);
	sub_wire16    <= data1x(2 DOWNTO 0);
	sub_wire15    <= data2x(2 DOWNTO 0);
	sub_wire14    <= data3x(2 DOWNTO 0);
	sub_wire13    <= data4x(2 DOWNTO 0);
	sub_wire12    <= data5x(2 DOWNTO 0);
	sub_wire11    <= data6x(2 DOWNTO 0);
	sub_wire10    <= data7x(2 DOWNTO 0);
	sub_wire9    <= data8x(2 DOWNTO 0);
	sub_wire8    <= data9x(2 DOWNTO 0);
	sub_wire7    <= data10x(2 DOWNTO 0);
	sub_wire6    <= data11x(2 DOWNTO 0);
	sub_wire5    <= data12x(2 DOWNTO 0);
	sub_wire4    <= data13x(2 DOWNTO 0);
	sub_wire3    <= data14x(2 DOWNTO 0);
	result    <= sub_wire0(2 DOWNTO 0);
	sub_wire1    <= data15x(2 DOWNTO 0);
...
-- Retrieval info: CONNECT: @data 1 10 3 0 data10x 0 0 3 0
-- Retrieval info: CONNECT: @data 1 11 3 0 data11x 0 0 3 0
-- Retrieval info: CONNECT: @data 1 12 3 0 data12x 0 0 3 0
-- Retrieval info: CONNECT: @data 1 13 3 0 data13x 0 0 3 0
-- Retrieval info: CONNECT: @data 1 14 3 0 data14x 0 0 3 0
-- Retrieval info: CONNECT: @data 1 15 3 0 data15x 0 0 3 0
...
-- Retrieval info: CONNECT: @data 1 8 3 0 data8x 0 0 3 0
-- Retrieval info: CONNECT: @data 1 9 3 0 data9x 0 0 3 0
